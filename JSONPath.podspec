...
Pod::Spec.new do |s|
  s.name             = 'JSONPath'
  s.version          = '0.1.0'
  s.summary          = 'A short description of JSONPath.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Bogdan Manshilin/JSONPath'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Bogdan Manshilin' => 'manshilin@yandex-team.ru' }
  s.source           = { :git => 'https://github.com/Bogdan Manshilin/JSONPath.git', :tag => s.version.to_s }
